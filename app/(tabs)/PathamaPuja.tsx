            ...
            <ScrollView className="flex-1" contentContainerStyle={{ flexGrow: 1 }}>
                <View className="flex-1 justify-center items-center px-6 py-12">
                    ...
                    <Text className="text-base text-yellow-700 text-center mb-8 leading-6 px-4">
                        Fitur Pathama Puja sedang dalam proses pengembangan. Mohon bersabar dan kembali lagi nanti.
                    </Text>

                    {/* Info Cards */}
                    <View className="w-full max-w-md space-y-4 mb-8">
                        {/* Card 1 */}
                        <View className="bg-white rounded-xl p-5 border-2 border-yellow-300 shadow-md">
                            <View className="flex-row items-start">
                                <View className="bg-yellow-100 p-3 rounded-full mr-4">
                                    <FontAwesome5 name="code" size={20} color="#854d0e" />
                                </View>
                                <View className="flex-1">
                                    ...
                                    <Text className="text-yellow-800 text-sm leading-5">
                                        Sedang dikerjakan untuk menghadirkan fitur terbaik
                                    </Text>
                                </View>
                            </View>
                        </View>
                        ...
                        {/* Card 2 */}
                        <View className="bg-white rounded-xl p-5 border-2 border-red-300 shadow-md">
                            <View className="flex-row items-start">
                                <View className="bg-red-100 p-3 rounded-full mr-4">
                                    <FontAwesome5 name="clock" size={20} color="#7f1d1d" />
                                </View>
                                <View className="flex-1">
